...
cd openelec-drivers
wget -nc http://www.mycvh.de/openelec/dvb-firmware/dvb-firmware-CvH-$CVH.tar.xz
tar xvf dvb-firmware-CvH-$CVH.tar.xz
...
#Copy firmware to bzroot
rsync -av $D/openelec-drivers/dvb-firmware-CvH-$CVH/firmware/ $D/bzroot-openelec/lib/firmware/
...
echo driver=\"$CVH\" >> $D/bzroot-openelec/etc/unraid-media
